...
<div class="container">
    <h1 class="titre">Bienvenue sur Festiv'All</h1>
    <!-- Hero Section -->
    <header class="bg-primary text-white text-center py-5">
        <div class="container">
            <h1 class="display-4">Bienvenue chez Festiv'All</h1>
    ...
    <section id="about" class="py-5">
        <div class="container text-center">
            ...
            <p class="lead">Festiv'All est une association joyeuse et conviviale basée à Angers. Chaque année, nous organisons le festival "Festiv'All-en-Scène" qui rassemble toutes les générations dans une ambiance festive et inclusive.</p>
        </div>
    </section>
    ...
    <section id="contact" class="py-5">
        <div class="container text-center">
            ...
            <a href="mailto:festivall@angers.fr" class="btn btn-outline-light btn-lg">Envoyer un email</a>
        </div>
    </section>
