<div class="container py-5">
    ...
    <?php else : ?>
        ...
        <div class="alert alert-warning text-center my-5 shadow-sm" role="alert">
            ...
            <p>Ajoutez des évènements à votre panier pour les voir apparaître ici.</p>
            <a href="index.php?controller=Programmation&action=displayProgrammationAction" class="btn btn-outline-primary mt-3">
                <i class="fas fa-shopping-basket"></i> Voir les évènements
            </a>
        </div>
    <?php endif; ?>
</div>